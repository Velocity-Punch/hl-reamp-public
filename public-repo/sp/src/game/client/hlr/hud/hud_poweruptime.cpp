...
void CHudProgressFF::Paint()
{
	...
	Color clrGlow = Color(255, 0, 0, max(20, bgAlpha));
	...
	m_icon_glow->DrawSelf(m_IconX, m_IconY + 2, clrGlow);
...
void CHudProgressOD::Paint()
{
	...
	Color clrGlow = Color(255, 105, 0, max(20, bgAlpha));
	...
	m_icon_glow->DrawSelf(m_IconX, m_IconY + 2, GetWide(), GetTall(), clrGlow);
...
void CHudProgressQJ::Paint()
{
	...
	Color clrGlow = Color(255, 220, 0, max(20, bgAlpha));
