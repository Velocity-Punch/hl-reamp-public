...
CHLRSubBonusOptionsGameplay::CHLRSubBonusOptionsGameplay(vgui::Panel* parent) : BaseClass(parent, NULL)
{
	...
	m_pactivehud = new CheckButton(this, "activehud", "Active Hud Movement");
...
void CHLRSubBonusOptionsGameplay::OnResetData()
{
	...
	ConVarRef activehud("hud_dynamic_movement");
	...
	m_pactivehud->SetSelected(activehud.GetBool());
...
void CHLRSubBonusOptionsGameplay::OnApplyChanges()
{
	...
	activehud.SetValue(m_pactivehud->IsSelected());
