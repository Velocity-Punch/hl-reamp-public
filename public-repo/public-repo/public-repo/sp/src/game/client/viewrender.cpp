...
ConVar g_test_thread_render("g_test_thread_render", "0");
//-----------------------------------------------------------------------------
...
ConVar r_queued_draw_test("r_queue_draw_test", "0");
...
void CSimpleWorldView::Draw()
{
	...
	if (r_queued_draw_test.GetBool())
	{
		g_pThreadPool->QueueCall(this, &CSimpleWorldView::DrawExecute, 0, CurrentViewID(), 0);
	}
	else
