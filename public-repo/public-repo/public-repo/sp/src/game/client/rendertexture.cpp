...
static CTextureReference g_rt_normalbuffer;
ITexture* GetNormalBuffer(void)
{
	if (!g_rt_normalbuffer)
	{
		g_rt_normalbuffer.Init(materials->FindTexture("_rt_NormalBuffer", TEXTURE_GROUP_RENDER_TARGET));
		AddReleaseFunc();
	}

	return g_rt_normalbuffer;
}
//=============================================================================
// Teeny Textures
//=============================================================================
